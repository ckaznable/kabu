...
export type Stock = { id: number; symbol: string; name: string | null; quantity: number; cost_basis: number; created_at: string; updated_at: string }

export type CreateStock = { symbol: string; name: string | null; quantity: number; cost_basis: number }
